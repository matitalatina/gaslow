...
describe("StringDownloader", () => {
  ...
  beforeEach(() => {
    ...
    axiosMock.onGet("https://raw.githubusercontent.com/matitalatina/gaslow/master/README.md")
      .reply(200, sampleResponse);
    
    // Set up a mock error response
    axiosMock.onGet("https://example.com/not-found")
      .reply(404, "Not Found");
  });
  ...
  it("should handle errors correctly", async () => {
    await expect(StringDownloader.download("https://example.com/not-found"))
      .rejects.toThrow();
  });
});
