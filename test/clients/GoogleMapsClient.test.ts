...
describe("GoogleMapsClient", () => {
  ...
  it("should extract the polygon", async () => {
    axiosMock
      .onGet(`https://maps.googleapis.com/maps/api/directions/json?origin=45.8725,9.73235&destination=45.464203,9.189982&key=${GOOGLE_API_KEY}`)
      .reply(200, aGoogleMapsApiDirectionResponse());

    const polygon = await client.getPolylineByRoute({lat: 45.872500, lng: 9.732350}, {lat: 45.464203, lng: 9.189982});
